    ...
    flex-col ${style.paddingY}`}>
      ...
      flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        justify-between items-center w-full">
          ...
          font-semibold ss:[72px] text-[52px]
        ...
        font-semibold ss:[68px] text-[52px]
        text-white ss:leading-[100px] leading-[75px] w-full'>
        Payment Method.</h1>
        <p className={`${style.paragraph} max-w-[470px] mt-5`}>Our team of experts uses a methodology 
        to identify the credit cards most likely to fit your needs. 
        e examine annual percentage rates, annual fees.</p>
